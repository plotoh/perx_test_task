...
- **улучшить логирование** (инфомрация, треккинг медленных запросов и т.п.)
...
- **тесты** – бязательно протестировать подключение к БД и Redis, работу репозитория, сервис с мок-зависимостями
